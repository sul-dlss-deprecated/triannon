  ...
  context "instance_methods" do
    ...
    context '#create_body_resources' do
      ...
      context "after create_resources_in_container" do
        before(:all) do
          @cassette_name = "Triannon_LdpWriter/instance_methods/after_create_body_resources"
          VCR.insert_cassette(@cassette_name)
    ...
    context '#create_target_resources' do
      ...
      context "after create_resources_in_container" do
        before(:all) do
          @cassette_name = "Triannon_LdpWriter/instance_methods/after_create_target_resources"
          VCR.insert_cassette(@cassette_name)
          my_ldpw = Triannon::LdpWriter.new @anno, @root_container
          @anno_id = my_ldpw.create_base
          @cntnrs_to_delete_after_testing << "#{@root_container}/#{@anno_id}"
